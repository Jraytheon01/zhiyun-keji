...
6. 逐字稿要像真实录音转写，口语特征出现在约 10%—20% 的发言中：语气词、少量重复、自我纠正、自然停顿或未完成句，以及确认、追问、澄清和反馈；不要每句都加语气词。
7. 专业内容、知识点和术语必须基本准确，符合参与者的身份关系和认知水平。
8. 教学场景必须自然包含讲解、提问、学习者作答、错误或困惑、纠正与进一步解释、练习或应用、理解情况与后续建议。
